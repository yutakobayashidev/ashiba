...
| `moonbit` | [MoonBit project with devshell](https://github.com/moonbit-community/moonbit-overlay) |
| `web-app` | [Web app template by hiroppy](https://github.com/hiroppy/web-app-template) |
